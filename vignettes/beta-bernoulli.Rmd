---
title: "Examples with the Beta-Bernoulli Model"
author: "Marc Box"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
bibliography: "references.bib"
vignette: >
  %\VignetteIndexEntry{Examples with the Beta-Bernoulli Model}
...
# Examples with the Beta-Bernoulli Model

This document reproduces the examples of Section 3.1 of @box2022importance and 
of Section 4.1 of @scott2016bayes. Section 1 explains the model, section 2 
reproduces the example with a single positive outcome and section 3 reproduces 
the example with 50%-50% positive and negative outcomes. Sections 2 and 3 
initialise data and the partitioned data, generate samples from the posterior 
and partial posterior distributions and employ the methods of 
@box2022importance, @scott2016bayes and @neiswanger2013asymptotically to 
approximate posterior inferences.
...
$$
x_i \sim \mathrm{Bernoulli}\left(\lambda\right), i = 1,2,\ldots,n
$$
...
The data of @scott2016bayes consists of 1,000 binary observations including a 
...
* <a id="">Scott, Steven L., Blocker, A.W., Bonassi, F.V., Chipman, H.A., George, E.I. and McCulloch, R.E., 2016. Bayes and big data: The consensus Monte Carlo algorithm. \emph{International Journal of Management Science and Engineering Management}, 11(2), pp.78-88.</a>
