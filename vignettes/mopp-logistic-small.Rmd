---
title: "MoPP in a Small Logistic Regression Example"
author: "Marc Box"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
bibliography: "references.bib"
vignette: >
  %\VignetteIndexEntry{MoPP in a Small Logistic Regression Example}
...
# MoPP in a Small Logistic Regression Example
...
posterior.estimates[["MoPP 1"]] <- rbind(
  ...
  "Std. Dev" = sqrt(mopp.mean(lapply(samples.part, FUN = function(theta) {theta ^ 2}), mopp.out$wn.type_1, type = 1, Hvec = mopp.out$Hvec) - posterior.estimates[["MoPP 1"]] ^ 2)
)
...
posterior.estimates[["MoPP 2"]] <- rbind(
  ...
  "Std. Dev" = sqrt(mopp.mean(lapply(samples.part, FUN = function(theta) {theta ^ 2}), mopp.out$wn.type_2, type = 2, Hvec = mopp.out$Hvec) - posterior.estimates[["MoPP 2"]] ^ 2)
)
